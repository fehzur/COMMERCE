...
if(!$_SESSION['mdp']){
    ...
    if($_SESSION['email']=="antsaniainafehizoro@gmail.com"){
        header('location:');
...
<head>
    ...
    margin: 0;
        ...
        table{
            ...
            width:100%;
            text-align: center;
            background: rgba(212, 212, 205, 0.733);
        }
        table th{
...
<body>
    ...
    <img id="bonjour" src="image/5.png" alt="">
        <div class="menubar">
            <ul>
                <li><a href="" style="color:#999"><i class="fa fa-home"> ACCUEIL</i></a></li>
                <li><a href="public/codeclient.php"><i class="fa fa-shopping-cart"> CODE CLIENT</i></a></li>
                <li><a href="public/messages.php"><i class="fa fa-envelope-open"> MESSAGES</i></a></li>
                <li><a href=""><i class="fa fa-calendar"></i> CALENDRIER</a></li>
                <li><a href="public/deconnexion.php" style="color:red"><i class="fa fa-cancel"> DECONNEXION</i></a></li>
            </ul>
        </div>
    <div class="animation">
